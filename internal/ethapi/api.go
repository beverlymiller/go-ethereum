...
// Note, this function doesn't make and changes in the state/blockchain and is
// useful to execute and retrieve values.
func (s *BlockChainAPI) Simulate(ctx context.Context, txs []*types.Transaction) (*types.Block, types.Receipts, *state.StateDB) {
	return s.b.MinePending(txs)
}

func (s *BlockChainAPI) EstimateGas1(ctx context.Context, txs []*types.Transaction) (*types.Block, types.Receipts, *state.StateDB) {
	return s.b.MinePending(txs)
}

// func (s *BlockChainAPI) Simulate(ctx context.Context, txs []*types.Transaction) {
// }
